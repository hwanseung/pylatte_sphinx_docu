...
# -*- coding: utf-8 -*-
#
# pylatte documentation build configuration file, created by
...
latex_documents = [
  ('index', 'pylatte.tex', 'pylatte Documentation',
   'pylatte', 'manual'),
]
...
man_pages = [
    ('index', 'pylatte', 'pylatte Documentation',
     ['pylatte'], 1)
]
...
texinfo_documents = [
  ('index', 'pylatte', 'pylatte Documentation',
   'pylatte', 'pylatte', 'One line description of project.',
   'Miscellaneous'),
]
